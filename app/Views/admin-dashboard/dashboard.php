...
<body>
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-100 min-h-screen transition-all main ">
        ...
        <!-- 3 card -->
        <div class="p-6 lg:mt-24  mx-28">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:mb-12">
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="text-2xl font-semibold mb-1">Jumlah transaksi</div>
                            <div class="flex gap-5 items-center ">
                                <i class="ri-bank-card-fill  text-6xl"></i>
                                <div class="text-xl font-medium text-gray-400">5</div>
                            </div>
                        </div>
                        <div class="text-right mt-28">
                        <p class="text-sm font-medium text-gray-600 ml-4">17-10-2023</p>
                        </div>
                        <!-- <div class="dropdown">
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            <div class="text-2xl font-semibold mb-1">Keuntungan</div>
                            <div class="flex gap-5 items-center ">
                            <i class="ri-money-dollar-circle-fill text-6xl"></i>
                                <div class="text-xl font-medium text-gray-400">Rp5000000,00</div>
                            </div>
                        </div>
                        <div class="text-right mt-28">
                        <p class="text-sm font-medium text-gray-600 ml-4">17-10-2023</p>
                ...
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    <div class="flex justify-between mb-6">
                        <div>
                            ...
                            <div class="flex gap-5 items-center ">
                            <i class="ri-money-dollar-circle-fill text-6xl"></i>
                            <div class="text-xl font-medium text-gray-400">Rp4500000,00</div>
                            </div>
                        </div>
                        <div class="text-right mt-28">
                        <p class="text-sm font-medium text-gray-600 ml-4">17-10-2023</p>
                            ...
                            <tbody>
                                <tr>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <div class="flex items-center">
                                            <img src="https://placehold.co/32x32" alt="" class="w-8 h-8 rounded object-cover block">
                                            <a href="#" class="text-gray-600 text-sm font-medium hover:text-blue-500 ml-2 truncate">Orak - arik jamur</a>
                                        </div>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">Rp17000,00</span>
                                    </td>
                                    <td class="py-2 px-4 border-b border-b-gray-50">
                                        <span class="text-[13px] font-medium text-gray-400">71</span>
                                    </td>
                                    <!-- <td class="py-2 px-4 border-b border-b-gray-50">
                                        <div class="dropdown">
