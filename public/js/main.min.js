...
Array.from(document.getElementsByClassName("dropdown")).forEach(function (e) {
  e.addEventListener("click", function (e) {
    ...
    e.currentTarget.classList.contains("navbar-item")
      ...
      : ((t = e.currentTarget.getElementsByClassName("mdi")[1]), e.currentTarget.parentNode.classList.toggle("active"), t.classList.toggle("mdi-plus"), t.classList.toggle("mdi-minus"));
  });
}),
